(() => {
  // =========================
  // 0) Shared Wallet bootstrap (не ломаемся если shared/wallet.js не загрузился)
  // =========================
  ...
  // обновление, если баланс менялся на другой странице
  ...
  $("#bonusBtn2")?.addEventListener("click", handleBonus);
  ...
  function spinToIndex(winIndex){
    return new Promise((resolve) => {
      ...
      // указатель сверху ( -PI/2 ), поэтому приводим так, чтобы sliceCenter оказался сверху
